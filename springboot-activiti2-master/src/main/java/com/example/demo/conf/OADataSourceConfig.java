 ...
 */
@Configuration
@MapperScan(basePackages = OADataSourceConfig.SCAN_PACKAGE, sqlSessionFactoryRef = OADataSourceConfig.BEAN_SQL_SESSION_FACTORY_NAME)
public class OADataSourceConfig {

    /* 多数据原配置 - 修改开始 */
    static final String SCAN_PACKAGE = "com.example.demo.mapper.oa";
    static final String MAPPER_LOCATION = "classpath*:mapper/oa/*.xml";
    static final String DATA_SOURCE_PROPERTIES_PREFIX = "oa.datasource";
    static final String BEAN_NAME_PREFIX = "oa";
    /* 多数据原配置 - 修改结束 */
