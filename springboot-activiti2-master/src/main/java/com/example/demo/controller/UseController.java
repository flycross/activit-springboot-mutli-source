...
public class UseController {
  ...
  @Autowired
  private ActivitiCustomService activitiCustomService;
    /**
     * 登录系统
     *
     * @param userName
    ...
    public String logon(@RequestParam("username") String userName, @RequestParam("password") String password, HttpSession session) {
        ...
        activitiCustomService.deleteFormPropertyByProcessInstanceId("123");
    ...
    public String logout(HttpSession session) {
       ...
       // return "redirect:http://localhost:8060/cas/logout";
        return "/login";
    }
